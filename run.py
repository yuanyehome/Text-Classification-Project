...
import numpy as np
import json
from utils import AverageMeter, count_parameters, layer_wise_parameters, human_format
...
def main():
    ...
    if args.model_name in ["LSTM", "RNN", "GRU"]:
        model = RnnModel(logger=logger, num_words=vocab_size, pretrained_embedding=TEXT.vocab.vectors,
        ...
        model = TextCNN(logger=logger, num_words=vocab_size, pretrained_embedding=TEXT.vocab.vectors,
